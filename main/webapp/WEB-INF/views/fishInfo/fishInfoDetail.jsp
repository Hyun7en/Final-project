...
<body onload="init('anotherFishAjax', `${pageContext.request.contextPath}` ,{fishType: `${fish.fishType}`, tendency: `${fish.tendency}`, tasteType: `${fish.tasteType}`, userNo: `${loginUser.userNo}` });">
	<div class="wrap">
