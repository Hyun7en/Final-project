                        ...
                        <div class="pageList" align="center">
                            <ul class="pagination">
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <li class="page-item"><a class="page-link" href="searchedOutlist.ma?categoryName=customer&condition=${condition}&keyword=${keyword}&cpage=${pi.currentPage - 1}">&laquo;</a></li>
                                    </c:otherwise>
                                </c:choose>
                        
                                <c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
                                    <c:set var="b" value="${boardLevel}"/>
                                    <li class="page-item ${p == pi.currentPage ? 'active' : ''}"><a class="page-link" href="searchedOutlist.ma?categoryName=customer&condition=${condition}&keyword=${keyword}&cpage=${p}">${p}</a></li>
                                </c:forEach>
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <li class="page-item"><a class="page-link" href="searchedOutlist.ma?categoryName=customer&condition=${condition}&keyword=${keyword}&cpage=${pi.currentPage + 1}">&raquo;</a></li>
                                    </c:otherwise>
                                </c:choose>
                            </ul>
                        </div>
