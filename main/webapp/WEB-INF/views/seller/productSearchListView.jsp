    ...
    <main>
        ...
        <section>
            ...
            <div id="pagination-div">
                <ul class="pagination">
                    <c:choose>
                        ...
                        <c:otherwise>
                            <li class="page-item"><a class="page-link" href="search.pd?cpage=${pi.currentPage - 1}">&laquo;</a></li>
                        </c:otherwise>
                </c:choose>

            <c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
                <li class="page-item ${p == pi.currentPage ? 'active' : ''}"><a class="page-link" href="search.pd?cpage=${p}">${p}</a></li>
            </c:forEach>
            ...
            <c:choose>
                    ...
                    <c:otherwise>
                        <li class="page-item"><a class="page-link" href="search.pd?cpage=${pi.currentPage + 1}">&raquo;</a></li>
                    </c:otherwise>
                </c:choose>
                </ul>
            </div>
