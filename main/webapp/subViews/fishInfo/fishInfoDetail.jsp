...
<title>Insert title here</title>
    ...
    <link rel="stylesheet" href="../../resources/css/fishInfoCSS/fishInfoDetail.css">
	<script src="../../resources/js/fishInfoJS/fishInfoDetail.js"></script>
	...
	<div class="wrap">
        ...
        <div id="main-div">
            ...
            <section id="fish-img-info">
                <div id="fish-img">
                    <img src="../../resources/image/fish1.png" alt="">
                </div>
                ...
                <div id="short-div">
                    <div id="short-info">
                        <div class="short-info-1234">
                            <div class="info-char">
                                <img src="../../resources/image/fishIcon.png" alt="" style="width: 30px; height: 19px;">
                            </div>
                        ...
                        <div class="short-info-1234">
                            <div class="info-char">
                                <img src="../../resources/image/growIcon.png" alt="" style="width: 19px; height: 19px;">
                            </div>
                            <div class="short-info-inside">
                        ...
                        <div class="short-info-1234">
                            <div class="info-char">
                                <img src="../../resources/image/tempIcon.png" alt="">
                            </div>
                            <div class="short-info-inside">
                        ...
                        <div class="short-info-1234">
                            <div class="info-char">
                                <img src="../../resources/image/phIcon.png" alt="" >
                            </div>
                            <div class="short-info-inside">
            ...
            <section id="fish-div-two">
                ...
                <div id="two-img-explain">
                    <div id=two-img>
                        <img src="../../resources/image/fishbowl.png" alt="">
                    </div>
                    <div >
                ...
                <div class="store-product">
                    <a href="#">
                        <div class="product-info">
                            <img src="../../resources/image/suzo.png" alt="">
                            <p>프리미엄 수조</p>
                            <p>36,000 원</p>
                        </div>
                    </a>
            ...
            <section id="another-fish">
                ...
                <div class="store-product">
                    <a href="#">
                        <div class="product-info">
                            <img src="../../resources/image/fishNeon.png" alt="">
                            <p>네온 테트라</p>
                        </div>
                    </a>
