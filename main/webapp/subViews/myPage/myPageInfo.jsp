            ...
            <div id="myPageInfo-wrapper" >
                <div id="myPage-sidebar">
                    <div id="myPage-sidebar-profile-area">
                        ...
                        <div id="myPage-sidebar-profile-nickName"><b>${login.nickname}</b>님 환영합니다.</div>
                    </div>
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" id="nickname" disabled value="${myInfo.nickName}홍길동">
                                ...
                                <tr>
                                    <th>한줄소개</th>
                                    <td>
                                        <input type="text" id="intro" disabled value="${myInfo.intro}안녕하세요. 잘 부탁드리겠습니다.">
                                        <button type="button" class="change-btn" id="intro-btn" onclick="change_intro()">변경</button>
                                    </td>
                                </tr>
                                <tr>
                                    <th>성별</th>
                                    <td>
                                        <input type="text" id="gender" disabled value="${myInfo.gender}남">
                                ...
                                <tr>
                                    <th>연락처</th>
                                    <td>
                                        <input type="text" id="phone" disabled value="${myInfo.phone}010-111-222">
                                ...
                                <tr>
                                    <th>이메일</th>
                                    <td>
                                        <input type="text" id="email" disabled value="${myInfo.email}race123@naver.com">
                                ...
                                <tr>
                                    <th>주소</th>
                                    <td>
                                        <input type="text" id="address" disabled value="${myInfo.address}경기도 안양시">
