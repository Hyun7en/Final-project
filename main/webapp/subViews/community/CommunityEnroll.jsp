    ...
    <div id="wrap">
        ...
        <main id="community-normal">
            ...
            <div id="com-enroll-content">
                <div id="com-enroll-content1">
                    <img src="${pageContext.request.contextPath}/resources/image/comimageupload.png" alt="사진 올리기">사진 올리기
                </div>
                <div id="com-enroll-content2">
                    <textarea name="본문" id="com-enroll-content-p" style="resize: none;"></textarea>
                </div>
                <div id="com-enroll-content3">
                    <div>첨부파일</div>
                    <div id="com-enroll-uploadlist"></div>
                </div>
            </div>
            <div id="com-enroll-bottom">
                <button id="com-grey-button">취소</button>
                <button id="com-blue-button">등록</button>
            </div>
        </main>
